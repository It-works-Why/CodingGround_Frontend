  ...
  <div class="rounded-3 mt-2 px-2 py-2 rank_background_box m-auto">
    ...
    <table :key="i" :value="notice" v-for="(notice, i) in noticeList" class="mt-1 text-white list_box m-auto">
      <tr>
        ...
        <td class="nickname">{{notice.nickname}}</td>
  ...
  data() {
    return {
      noticeList: [
        {
          num: '9',
          title: '시스템정기 점검으로 인한 서비스 이용 불가 사항 안내',
          nickname: '관리자',
          date : '2023.11.21',
        },
        {
        ...
        {
          num: '6',
          title: '운영수칙 위반에 따른 제재 안내',
          nickname: '관리자',
          date : '2022.09.09',
        },
        {
          num: '5',
          title: '단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또단또',
          nickname: '관리자',
          date : '2022.04.11',
        },
      ],
